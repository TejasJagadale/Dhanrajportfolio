    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center">
          ...
          />
          <CustomLink className="mx-4" href="/honors" title="Honors" />
        ...
        <nav
          ...
          <button
            onClick={() => setMode(mode === "light" ? "light" : "light")}
      ...
      -translate-y-1/2 py-32 bg-dark/90 rounded-lg z-50 backdrop-blur-md "
